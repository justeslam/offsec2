...
$fileNames = @("PowerUp.ps1", "PowerView.ps1", "Rubeus.exe", "SharpHound.ps1", "mimikatz.exe", "winpeas.exe", "PrintSpoofer64.exe", "PsLoggedOn.exe", "kerbrute.exe", "agent.exe", "Invoke-RunasCs.ps1", "GodPotato-NET2.exe", "nc.exe", "privesccheck.ps1")
